...
L_values = [0.095:0.005:0.3];  % You can adjust these values as needed
...
%% Final form of equation conversion from symbols to numerics 
        ...
        w_dot_str=strrep(w_dot_str,'W3(t)',num2str(rpm1/50));
        w_dot_str=strrep(w_dot_str,'W4(t)',num2str(rpm1/50));
...
X_values_cell = cell(length(L_values), 1);
...
xlswrite('X_values.xlsx', X_values_cell, 'Sheet1');

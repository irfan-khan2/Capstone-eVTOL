...
%% Rotational EOM 
    ...
    I=[0.001 0 0; 
        0 0.001 0; 
        0 0 0.001]; %Moment of inertia matrix 
...
%% Final form of equation conversion from symbols to numerics 
    ...
    w_dot_str=strrep(w_dot_str,'W1(t)','(600)');
    w_dot_str=strrep(w_dot_str,'W2(t)','(500)');
    w_dot_str=strrep(w_dot_str,'W3(t)','(600)');
    w_dot_str=strrep(w_dot_str,'W4(t)','(500)');

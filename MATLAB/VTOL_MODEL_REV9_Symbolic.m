...
%% Final form of equation conversion from symbols to numerics 
        ...
        w_dot_str=strrep(w_dot_str,'W1(t)',num2str(rpm1/5));
        w_dot_str=strrep(w_dot_str,'W2(t)',num2str(rpm1/5));
        w_dot_str=strrep(w_dot_str,'W3(t)',num2str(rpm1/20));
        w_dot_str=strrep(w_dot_str,'W4(t)',num2str(rpm1/20));
